...
$ret=mysqli_query($con,"update students set studentName='$studentname',studentPhoto='$photo',average='$average'  where StudentRegno='$regid'");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="average" name="average"  value="<?php echo htmlentities($row['average']);?>" required />
  </div>  
