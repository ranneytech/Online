...
<tr class="item">
            ...
            <tr class="item">
                ...
                <td>
                    <?php echo htmlentities($row['saverage']);?>
                </td>
            </tr>
