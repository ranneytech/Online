                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post">
                            <div class="text-center">
                                <button type="submit" name="delete_logs" class="btn btn-danger">Delete All Logs</button>
                            </div>
                        </form>
                        <?php
                        if (isset($_POST['delete_logs'])) {
                            $sql = mysqli_query($con, "delete from userlog");
                            echo "<script>alert('All logs deleted');</script>";
                            echo "<script>window.location.href='user-log.php'</script>";
                        }
                        ?>
